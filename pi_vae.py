...
### remark: this step is to get the poisson firing output with an realnvp_layer, not sure yet why it's related to poisson, but there is no recurrent network happening here.
